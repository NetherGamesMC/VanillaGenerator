...
final class BiomeHeightManager{
	...
	public static function init() : void{
		...
		self::register(new BiomeHeight(0.2, 0.2), BiomeIds::TAIGA, BiomeIds::TAIGA_COLD);
		...
		self::register(new BiomeHeight(0.2, 0.4), BiomeIds::MUTATED_BIRCH_FOREST, BiomeIds::MUTATED_ROOFED_FOREST);
		self::register(new BiomeHeight(0.3, 0.4), BiomeIds::MUTATED_TAIGA, BiomeIds::MUTATED_TAIGA_COLD);
